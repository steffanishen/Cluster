...
//    GROUP *sel1;
 //   int whichN;
    ...
    ANALYSIS_PERSISTENCE(PSF *system, GROUP *sel1, int vector1d, int vector2d, int voidf, string filename, string xyz_filename, float dist_crit, float cellsize); //constructor
